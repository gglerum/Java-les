...
import frl.hacklab.librarysystem.item.ReferenceItem;
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    // Add reference items
    referenceItems.add(
        new Dictionary("ref01", "English Dictionary", "A comprehensive dictionary."));
    referenceItems.add(new Encyclopedia("ref02", "World Encyclopedia",
        "A collection of knowledge on various topics."));
